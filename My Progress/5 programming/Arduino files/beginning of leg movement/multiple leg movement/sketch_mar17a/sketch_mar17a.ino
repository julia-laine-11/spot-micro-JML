...
void returnFeet(String side, String side2, String returning, String returning2){
  Servo topArm = topArm + String return side;
  Servo midArm = midArm + String return side;
